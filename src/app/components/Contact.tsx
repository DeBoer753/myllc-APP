...
export default function ContactFormWithSocialButtons() {
  ...
  return (
    <Flex id="contact" bg={useColorModeValue('gray.100', 'gray.900')} align="center" justify="center" css={{ backgroundImage: useColorModeValue(CONFETTI_LIGHT, CONFETTI_DARK), backgroundAttachment: 'fixed'}}>
